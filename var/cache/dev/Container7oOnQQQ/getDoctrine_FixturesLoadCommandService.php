...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/CompetencesFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/GroupeDeTagFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ProfilDeSortieFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\CompetencesFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\GroupeDeTagFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ProfilDeSortieFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\ProfilFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\PromoFixtures(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\UserFixtures(($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService'))), 'groups' => []]]);
